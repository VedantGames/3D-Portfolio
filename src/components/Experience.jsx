...
function Experience() {
  ...
  return (
    <div>
      <ParallaxLayer offset={3} speed={0.27} className='bg-[#011825] md:mt-[40rem] mt-[70rem]'>
        <motion.div
            ref={ref}
            animate={controls}
            initial='hidden'
          ...
          >
          <h1 className='md:text-8xl text-6xl font-bold mb-20 flex justify-center'>
            Experience
          </h1>
        </motion.div>
      </ParallaxLayer>
      <ParallaxLayer offset={3} speed={0.27} className='bg-[#011825] md:mt-[52rem] mt-[76rem] h-full'>
