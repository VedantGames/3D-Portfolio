    ...
    <ParallaxLayer offset={5} speed={0.27} className='bg-[#011825] h-full'>
      <div className='bg-[#011825] flex justify-end items-center flex-col size-full z-50 md:mt-36 mt-[70rem]'>
        <div className='w-full flex justify-center'>
          <h1 className={'md:text-7xl font-bold text-center mb-36 ' + (window.innerWidth > 370 ? 'text-4xl' : 'text-5xl')}>For BEST Services.</h1>
        </div>
        <div className='flex justify-center items-center flex-col mb-20'>
          ...
          <h2 className={'text-center w-full font-bold mb-2 ' + (window.innerWidth > 370 ? 'text-5xl' : 'text-3xl pb-2')}>Vedant GUPTA</h2>
