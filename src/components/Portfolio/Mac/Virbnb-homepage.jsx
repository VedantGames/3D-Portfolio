...
Command: npx gltfjsx@6.2.18 .\Virbnb-homepage.glb 
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/Models/Mac/Portfolio/Virbnb-homepage.glb')
  return (
...
useGLTF.preload('/Virbnb-homepage.glb')
