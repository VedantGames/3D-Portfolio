...
function Portfilio() {
  ...
  return (
    ...
    <ParallaxLayer offset={2} speed={0.27} className='bg-[#011825]'>
      ...
      <ParallaxLayer offset={1} speed={0.27} className='bg-[#011825] xl:px-52 px-32'>
        <div className='pt-44'></div>
          <Title />
      </ParallaxLayer>
      <ParallaxLayer offset={1} speed={0.27} className='bg-[#011825] xl:px-52 px-32 mt-96'>
        <Card
          right={true}
      ...
      <ParallaxLayer offset={1} speed={0.27} className='bg-[#011825] xl:px-52 px-32 mt-[100rem]'>
          <motion.div
            ref={ref}
            animate={controls}
            initial='hidden'
            ...
            <Link to={'https://virbnb.vercel.app'} target='_blank' className='flex justify-between w-full h-full xl:gap-20 gap-10 mb-16'>
              ...
              >
                <div className='flex flex-col gap-5 justify-center'>
                  ...
                  <h2 className='xl:text-2xl text-lg'>
