...
function Portfilio() {
  ...
  return (
    ...
    <ParallaxLayer offset={2} speed={0.27} className='bg-[#011825]'>
      ...
      <ParallaxLayer offset={1} speed={0.27} className='bg-[#011825] xl:px-52 md:px-32 px-20'>
        <div className='md:pt-44'></div>
          <Title />
      </ParallaxLayer>
      <ParallaxLayer offset={1} speed={0.27} className='bg-[#011825] xl:px-52 md:px-32 px-10 md:mt-96 mt-64'>
        <Card
          right={true}
      ...
      <ParallaxLayer offset={1} speed={0.27} className='bg-[#011825] xl:px-52 md:px-32 px-20 md:mt-[58rem] mt-[65rem]'>
          <Card 
            right={false}
      ...
      <ParallaxLayer offset={1} speed={0.27} className='bg-[#011825] xl:px-52 md:px-32 px-10 md:mt-[100rem] mt-[122rem]'>
          <motion.div
            ref={ref}
            animate={controls}
            initial='hidden'
          ...
          >
            <Link to={'https://virbnb.vercel.app'} target='_blank' className='flex justify-between w-full h-full xl:gap-20 gap-10 mb-16 md:mt-0 mt-10 md:flex-row flex-col-reverse'>
              <motion.div
                ref={ref}
                animate={controls}
                initial='hidden'
      ...
      <ParallaxLayer offset={1} speed={0.27} className='bg-[#011825] xl:px-52 md:px-32 px-10 md:mt-[135rem] mt-[162rem]'>
          <motion.div
            ref={ref}
            animate={controls}
            initial='hidden'
            variants={fadeIn("up", "spring", 0.5, 0.75)}
          >
            <Link to={'http://portfolio-vedant.vercel.app'} target='_blank' className='flex md:flex-row flex-col justify-between w-full h-full xl:gap-20 gap-10 mb-16'>
              <div>
